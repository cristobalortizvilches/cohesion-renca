  ...
  mutate(t05_w06 = factor(t05_w06,labels=c("Si, a otro barrio de la comuna","Si, a otra comuna","No, estoy bien donde estoy",
         ...
         t10_w06 = factor(case_when(
           ...
           t10_w06 %in% c(4,5) ~ 3
                    ...
                    "Seguro")),
         c07_01_w05 = factor(c07_01_w05,labels=c("No lo ha hecho","Lo ha hecho una o dos veces",
                                                 "Lo ha hecho más de dos veces"))) %>%
...
```{r segu-barrial,fig.cap="\\label{fig:seguridad.elsoc}Percepción de seguridad en el barrio (ELSOC)"}
