...
```{r participacion2,fig.cap="\\label{fig:prticipacion}Porcentaje de personas que participa en alguna asociación"}
#remove("particip")
...
El Gráfico \ref{fig:act_cvica} muestra el porcentaje de personas que declara haber participado en distintas instancias de activismo. En general se observa que, entre quienes participan, la mayoría ha ocupado las redes sociales para expresar sus opiniones (35%) seguido de la asistencia a reuniones (29%).
